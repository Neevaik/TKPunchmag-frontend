    ...
    <header className="sticky top-0 z-50 flex items-center justify-between border-b border-border-dark bg-background-dark/95 px-4 py-3 backdrop-blur-md md:px-10">
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden items-center gap-8 border-l border-border-dark pl-8 lg:flex">
          <Link
            href="/shop"
            className="text-sm font-bold uppercase text-white hover:text-primary"
          >
            Shop
          </Link>
          ...
          <div className="group relative">
            ...
            <div className="invisible absolute left-0 top-full z-50 w-[500px] pt-2 opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100">
